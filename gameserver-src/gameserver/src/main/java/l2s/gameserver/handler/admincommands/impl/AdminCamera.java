        ...
        switch (command) {
            case admin_freelook: {
                ...
                if (mode == 1) {
                    ...
                    activeChar.sendPacket((IBroadcastPacket)CameraModePacket.ENTER);
                    break;
                }
                ...
                activeChar.sendPacket((IBroadcastPacket)CameraModePacket.EXIT);
                break;
            }
            case admin_cinematic: {
                ...
                activeChar.sendPacket((IBroadcastPacket)new SpecialCameraPacket(id, dist, yaw, pitch, time, duration));
                break;
            }
        }
        return true;
