...
public enum Stats {
    ...
    PLAYER_MAX_HP_LIMIT("max_hp_limit", 0.0, Double.POSITIVE_INFINITY, 1.0),
    PLAYER_MAX_MP_LIMIT("max_mp_limit", 0.0, Double.POSITIVE_INFINITY, 1.0),
    PLAYER_MAX_CP_LIMIT("max_cp_limit", 0.0, Double.POSITIVE_INFINITY, 1.0),
    ...
    P_ATTACK_RADIUS("p_attack_radius", 0.0, 1500.0),
    ...
    BASE_ELEMENTS_DEFENCE("elements_defence", -600.0, 600.0),
    ...
    P_SKILL_EVASION("pSkillEvasion", 100.0, 200.0),
    ...
    AGATHIONS_LIMIT("agathions_limit", 0.0, 5.0),
    ...
    PHYSICAL_ABNORMAL_RESIST("p_physical_abnormal_resist", -100.0, 100.0),
    MAGIC_ABNORMAL_RESIST("p_magic_abnormal_resist", -100.0, 100.0),
    ...
    VAMPIRIC_ATTACK("vampiric_attack", 0.0, 100.0),
    MP_VAMPIRIC_ATTACK("mp_vampiric_attack", 0.0, 100.0),
    ...
    public static Stats valueOfXml(String name) {
        ...
        for (Stats s : VALUES) {
            if (!s.getValue().equals(upperCaseName)) continue;
            return s;
        }
