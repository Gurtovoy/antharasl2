...
public class HtmTemplates
extends HashIntObjectMap<String> {
    ...
    public String get(int key) {
        ...
        if (value == null) {
            _log.warn("Dialog: data/html/" + this._lang.getShortName() + "/" + this._fileName + " not found template ID[" + key + "].");
            return "";
        }
        return value;
    }

    private static class EmptyHtmTemplates
    extends HtmTemplates {
        ...
        public boolean equals(Object o) {
            return o instanceof HtmTemplates && ((HtmTemplates)((Object)o)).size() == 0;
        }
