...
implements TelnetCommandHolder {
    ...
    public TelnetPerfomance() {
            ...
            public String handle(String[] args) {
                ...
                if (args.length == 0 || args[0].isEmpty()) {
                    ...
                    try {
                        ...
                        FileUtils.writeStringToFile((File)new File("stats/RunnableStats-" + new SimpleDateFormat("MMddHHmmss").format(System.currentTimeMillis()) + ".txt"), (String)RunnableStatsManager.getInstance().getStats().toString(), (String)"UTF-8");
        ...
        this._commands.add(new TelnetCommand("threads", new String[]{"t"}){
            ...
            public String handle(String[] args) {
                ...
                if (args.length == 0 || args[0].isEmpty()) {
                    ...
                    try {
                        new File("stats").mkdir();
                        FileUtils.writeStringToFile((File)new File("stats/ThreadsDump-" + new SimpleDateFormat("MMddHHmmss").format(System.currentTimeMillis()) + ".txt"), (String)StatsUtils.getThreadStats((boolean)true, (boolean)true, (boolean)true).toString(), (String)"UTF-8");
        ...
        this._commands.add(new TelnetCommand("dbstats", new String[]{"ds"}){
