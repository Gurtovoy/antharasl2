...
public class OlympiadParticipantsDAO {
    ...
    public void select() {
        ...
        try {
            ...
            try {
                _log.error("OlympiadParticipantsDAO:select():", (Throwable)e);
            }
    ...
    public void replace(int participantId) {
        ...
        try {
            ...
            try {
                _log.error("OlympiadParticipantsDAO:replace(int): " + participantId, (Throwable)e);
            }
            catch (Throwable throwable) {
    ...
    public void delete(int participantId) {
        ...
        try {
            ...
            try {
                _log.error("OlympiadParticipantsDAO:delete(int): " + participantId, (Throwable)e);
            }
            catch (Throwable throwable) {
                DbUtils.closeQuietly((Connection)con, statement);
                throw throwable;
