...
public class Log {
    ...
    private static final Logger _logMultisell = LoggerFactory.getLogger((String)"multisell");
    private static final Logger _logBans = LoggerFactory.getLogger((String)"bans");
    ...
    public static void add(PrintfFormat fmt, Object[] o, String cat) {
        Log.add(fmt.sprintf(o), cat);
    }

    public static void add(String fmt, Object[] o, String cat) {
        Log.add(new PrintfFormat(fmt).sprintf(o), cat);
    }
    ...
    public static void LogItem(String className, int objId, String process, ItemInstance item) {
        Log.LogItem(className, objId, process, item, item.getCount());
    }
