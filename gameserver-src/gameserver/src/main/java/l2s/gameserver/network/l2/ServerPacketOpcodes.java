...
public enum ServerPacketOpcodes {
    ...
    ExCardUpdownGameStart,
    ExCardUpdownPickResult,
    ExCardUpdownPrepareReward,
    ExCardUpdownGameRewardReply,
    ExCardUpdownGameQuit,
    ExArenaRankAll,
    ExArenaMyrank,
    ExPledgeClassicRaidInfo,
    ExArenaObserve,
    ExHtmlWithNpcViewport,
    ExPledgeContributionRank,
    ExPledgeContributionInfo,
    ExPledgeContributionReward,
    ExPledgeRaidInfo,
    ExPledgeRaidRank,
    ExPledgeLevelUp,
    ExPledgeShowInfoUpdate,
    ExPledgeMissionInfo,
    ExPledgeMissionRewardCount,
    ExPledgeMasteryInfo,
    ExPledgeMasterySet,
    ExPledgeMasteryReset,
    ExTutorialShowId,
    ExPledgeSkillInfo,
    ExPledgeSkillActivate,
    ExPledgeItemList,
    ExPledgeItemActivate,
    ExPledgeAnnounce,
    ExPledgeAnnounceSet,
    ExSetPledgeEmblem,
    ExShowCreatePledge,
    ExPledgeItemInfo,
    ExPledgeItemBuy,
    ExElementalSpiritInfo,
    ExElementalSpiritExtractInfo,
    ExElementalSpiritEvolutionInfo,
    ExElementalSpiritEvolution,
    ExElementalSpiritSetTalent,
    ExElementalSpiritAbsorbInfo,
    ExElementalSpiritAbsorb,
    ExChooseLockedItem,
    ExLockedResult,
    ExDressRoomUIOpen,
    ExDressHangerList,
    ...
    public static final ServerPacketOpcodes[] VALUES;
    ...
    static {
        VALUES = ServerPacketOpcodes.values();
    }
}
