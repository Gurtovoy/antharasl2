...
extends Event {
    ...
    public boolean canIncreasePvPPKCounter(Player killer, Player target) {
        return this.checkPvPFlag(killer, target);
    }
    ...
    public class OnDeathFromUndyingListenerImpl
    implements OnDeathFromUndyingListener {
        @Override
        public void onDeathFromUndying(Creature actor, Creature killer) {
            SingleMatchEvent.this.onDie((Player)actor);
        }
    }
}
