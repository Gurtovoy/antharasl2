...
implements IAdminCommandHandler {
    ...
    public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar) {
        ...
        switch (command) {
            case admin_show_spawns: {
                activeChar.sendPacket((IBroadcastPacket)new HtmlMessage(5).setFile("admin/spawns.htm"));
                break;
            }
            case admin_print_spawnzone: {
                ...
                NpcInstance npcTarget = (NpcInstance)target;
            ...
            case admin_spawn_index: {
                try {
                    ...
                    activeChar.sendPacket((IBroadcastPacket)new HtmlMessage(5).setFile("admin/spawns/" + val + ".htm"));
                }
            ...
            case admin_spawn1: {
                ...
                try {
                    ...
                    this.spawnMonster(activeChar, id, 0, mobCount, false);
                }
                catch (Exception e) {}
                break;
            }
            case admin_spawn2: {
                ...
                try {
                    ...
                    this.spawnMonster(activeChar, id, respawnTime, mobCount, true);
                }
                catch (Exception e) {}
                break;
            }
            ...
            case admin_spawn_monster: {
                ...
                try {
                    ...
                    this.spawnMonster(activeChar, id, respawnTime, mobCount, false);
                }
                catch (Exception e) {}
                break;
            }
            case admin_setai: {
                ...
                NpcInstance npcTarget = (NpcInstance)activeChar.getTarget();
                ...
                if (aiConstructor == null) break;
                try {
                    npcTarget.setAI((CharacterAI)aiConstructor.newInstance(npcTarget));
                }
                catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            case admin_generate_loc: {
                ...
                for (NpcInstance _npc : World.getAroundNpc(activeChar)) {
                    if (_npc.getNpcId() != id && _npc.getNpcId() != id2) continue;
                    name = _npc.getName();
            ...
            case admin_dumpspawn: {
                ...
                try {
                    ...
                    int respawnTime = 30;
                    int mobCount = 1;
                    this.spawnMonster(activeChar, id3, respawnTime, mobCount, false);
                    try {
    ...
    private void spawnMonster(Player activeChar, String monsterId, int respawnTime, int mobCount, boolean ignoreSpawnedRB) {
        ...
        if ((regexp = (pattern = Pattern.compile("[0-9]*")).matcher(monsterId)).matches()) {
