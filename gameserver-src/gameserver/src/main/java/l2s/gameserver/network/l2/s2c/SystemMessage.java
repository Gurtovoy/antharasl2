...
extends L2GameServerPacket {
    ...
    public SystemMessage addString(String text) {
        this.args.add(new Arg(0, StringUtils.defaultString((String)text)));
        return this;
    }

    public SystemMessage addNumber(int number) {
        this.args.add(new Arg(1, number));
        return this;
    }

    public SystemMessage addNumber(long number) {
        this.args.add(new Arg(6, number));
        return this;
    }

    public SystemMessage addNumber(byte number) {
        this.args.add(new Arg(20, number));
        return this;
    }
    ...
    public SystemMessage addName(Creature cha) {
        ...
        if (cha.isNpc()) {
            ...
            if (npc.getTemplate().displayId != 0 || !npc.getName().equals(npc.getTemplate().name)) {
                return this.addString(npc.getName());
            }
    ...
    public SystemMessage addDoorName(int id) {
        this.args.add(new Arg(11, new Integer(id)));
        return this;
    }

    public SystemMessage addNpcName(int id) {
        this.args.add(new Arg(2, new Integer(1000000 + id)));
        return this;
    }

    public SystemMessage addItemName(int id) {
        this.args.add(new Arg(3, id));
        return this;
    }

    public SystemMessage addZoneName(Location loc) {
        this.args.add(new Arg(7, loc));
        return this;
    }

    public SystemMessage addSkillName(int id, int level) {
        this.args.add(new Arg(4, new int[]{id, level}));
        return this;
    }
    ...
    protected final void writeImpl() {
        ...
        this.writeH(this._messageId);
        this.writeC(this.args.size());
        for (Arg e : this.args) {
            this.writeC(e.type);
            switch (e.type) {
                case 0: 
                ...
                case 20: {
                    this.writeC(((Number)e.obj).byteValue());
                }
            }
        }
    }
