...
extends AbstractParser<DoorHolder> {
    ...
    protected void readData(Element rootElement) throws Exception {
        ...
        while (iterator.hasNext()) {
            ...
            if (!"door".equals(doorElement.getName())) continue;
            ...
            while (i.hasNext()) {
                ...
                if (!"ai_params".equals(n.getName())) continue;
                if (aiParams == null) {
                    aiParams = new StatsSet();
                    doorSet.set("ai_params", (Object)aiParams);
                }
