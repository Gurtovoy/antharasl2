        ...
        this._commands.add(new TelnetCommand("dumpnpc", new String[]{"dnpc"}){
            ...
            public String handle(String[] args) {
                ...
                while (itr.hasNext()) {
                    itr.advance();
                    int id = itr.key();
                    list = (List<NpcInstance>)itr.value();
                ...
                try {
                    ...
                    FileUtils.writeStringToFile((File)new File("stats/NpcStats-" + new SimpleDateFormat("MMddHHmmss").format(System.currentTimeMillis()) + ".txt"), (String)sb.toString(), (String)"UTF-8");
                }
                catch (IOException e) {
                    e.printStackTrace();
                }
