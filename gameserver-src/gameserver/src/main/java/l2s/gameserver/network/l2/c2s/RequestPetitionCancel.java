    ...
    protected void runImpl() {
        ...
        if (PetitionManager.getInstance().isPlayerInConsultation(activeChar)) {
            if (activeChar.isGM()) {
                ...
                activeChar.sendPacket((IBroadcastPacket)SystemMsg.YOUR_PETITION_IS_BEING_PROCESSED);
            }
            ...
            if (PetitionManager.getInstance().cancelActivePetition(activeChar)) {
                ...
                activeChar.sendPacket((IBroadcastPacket)new SystemMessagePacket(SystemMsg.THE_PETITION_WAS_CANCELED_YOU_MAY_SUBMIT_S1_MORE_PETITIONS_TODAY).addInteger(numRemaining));
                ...
                activeChar.sendPacket((IBroadcastPacket)SystemMsg.FAILED_TO_CANCEL_PETITION_PLEASE_TRY_AGAIN_LATER);
            }
        } else {
            activeChar.sendPacket((IBroadcastPacket)SystemMsg.YOU_HAVE_NOT_SUBMITTED_A_PETITION);
        }
    }
}
