...
public final class PetDataHolder
extends AbstractHolder {
    ...
    private static final TIntObjectMap<PetData> _templatesByNpcId = new TIntObjectHashMap();
    private static final TIntObjectMap<PetData> _templatesByItemId = new TIntObjectHashMap();
    ...
    public PetData getTemplateByNpcId(int npcId) {
        return (PetData)_templatesByNpcId.get(npcId);
    }

    public PetData getTemplateByItemId(int itemId) {
        return (PetData)_templatesByItemId.get(itemId);
    }
