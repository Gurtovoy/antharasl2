...
public class ExShowAgitSiegeInfo
extends L2GameServerPacket {
    ...
    public ExShowAgitSiegeInfo() {
        ...
        clanHalls.forEach(clanHall -> {
            ...
            int siegeDate = (int)(clanHall.getSiegeDate().getTimeInMillis() / 1000L);
            this._infos.add(new AgitInfo(clan_name, leader_name, ch_id, getType, siegeDate));
        });
    }
    ...
    protected final void writeImpl() {
        ...
        this._infos.forEach(info -> {
            ...
            this.writeD(info.siegeDate);
            this.writeString(info.clan_name);
            this.writeString(info.leader_name);
            this.writeH(info.getType);
        });
    }
