...
public class CastleHiredGuardDAO {
    ...
    public void load(Castle r) {
        ...
        try {
            ...
            try {
                _log.error("CastleHiredGuardDAO:load(Castle): " + e, (Throwable)e);
            }
    ...
    public void insert(Residence residence, int itemId, Location loc) {
        ...
        try {
            ...
            try {
                _log.error("CastleHiredGuardDAO:insert(Residence, int, Location): " + e, (Throwable)e);
            }
            catch (Throwable throwable) {
    ...
    public void delete(Residence residence, ItemInstance item) {
        ...
        try {
            ...
            try {
                _log.error("CastleHiredGuardDAO:delete(Residence): " + e, (Throwable)e);
            }
            catch (Throwable throwable) {
                DbUtils.closeQuietly((Connection)con, statement);
                throw throwable;
