...
implements IAdminCommandHandler {
    @Override
    public boolean useAdminCommand(Enum<?> comm, String[] wordList, final String fullString, final Player activeChar) {
        final Commands command = (Commands)comm;
        if (!activeChar.getPlayerAccess().CanReload) {
            return false;
        }
        activeChar.ask((ConfirmDlgPacket)new ConfirmDlgPacket(SystemMsg.S1, 0).addString(activeChar.isLangRus() ? "\u041f\u0435\u0440\u0435\u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0430 \u043a\u043e\u043c\u043f\u043e\u043d\u0435\u043d\u0442\u043e\u0432 \u0441\u0435\u0440\u0432\u0435\u0440\u0430 \u043c\u043e\u0436\u0435\u0442 \u043f\u0440\u0438\u0432\u0435\u0441\u0442\u0438 \u043a \u043d\u0435\u043f\u0440\u0435\u0434\u0441\u043a\u0430\u0437\u0443\u0435\u043c\u044b\u043c \u043f\u043e\u0441\u043b\u0435\u0434\u0441\u0442\u0432\u0438\u044f\u043c! \u041f\u0440\u043e\u0434\u043e\u043b\u0436\u0438\u0442\u044c?" : "Rebooting server components can lead to unpredictable consequences! Continue?"), new OnAnswerListener(){
                    ...
                    case admin_reload_qs: {
                        if (fullString.endsWith("all")) {
                            for (Player p : GameObjectsStorage.getPlayers(false, false)) {
                                AdminReload.this.reloadQuestStates(p);
                            }
                            break;
                        }
                        ...
                        AdminReload.this.reloadQuestStates(activeChar);
                        break;
                    }
        ...
        activeChar.sendPacket((IBroadcastPacket)new HtmlMessage(5).setFile("admin/reload.htm"));
        return true;
    }
