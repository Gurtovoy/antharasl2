...
public enum ClanSearchPlayerRoleType {
    ...
    public static final ClanSearchPlayerRoleType[] VALUES;
    ...
    public boolean isClassRole(int classId) {
        ...
        for (int roleClassId : this._classIds) {
            if (roleClassId != classId) continue;
            return true;
        }
        return false;
    }
    ...
    static {
        VALUES = ClanSearchPlayerRoleType.values();
    }
}
