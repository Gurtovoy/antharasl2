...
extends Skill {
    ...
    public void onEndCast(Creature activeChar, Set<Creature> targets) {
        ...
        if (activeChar.isPlayer()) {
            activeChar.sendMessage(new CustomMessage("l2s.gameserver.skills.skillclasses.Default.NotImplemented").addNumber(this.getId()).addString("" + (Object)((Object)this.getSkillType())));
        }
