...
public class RequestJoinPledgeByName
extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        if (activeChar.getName().equalsIgnoreCase(this._targetName)) {
        ...
        Player member = GameObjectsStorage.getPlayer(this._targetName);
        if (member == null) {
