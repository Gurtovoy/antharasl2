...
public enum NpcString {
    ...
    VALAKAS_OVERWHELMED_BY_ATTACK_NOW_TIME_ATTACK(0x1B7B71),
    ...
    TALK_TO_THE_APPRENTICE_ADVENTURERS_GUIDE(0x1B8111),
    ...
    DO_YOU_THINK_ILL_GROW_TALLER_IF_I_EAT_LOTS_AND_LOTS(0x1B818B),
    ...
    GROW_STRONGER_HERE_UNTIL_YOU_RECEIVE_THE_NEXT_LETTER_FROM_QUEEN_NAVARI_AT_LV_58(0x1B81B1),
    ...
    DONT_TELL_ANYONE_ABOUT_MY_DEATH(0x1B7B11),
    ...
    private NpcString(int id) {
        this._id = id;
        this._size = this.name().contains("S4") ? 4 : (this.name().contains("S3") ? 3 : (this.name().contains("S2") ? 2 : (this.name().contains("S1") ? 1 : 0)));
    }
