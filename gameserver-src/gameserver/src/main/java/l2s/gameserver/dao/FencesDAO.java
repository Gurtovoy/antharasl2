...
public class FencesDAO {
    ...
    public void restore() {
        ...
        try {
            ...
            try {
                _log.error("FencesDAO:restore()", (Throwable)e);
            }
    ...
    public boolean insert(FenceInstance fence) {
        ...
        try {
            ...
            boolean bl;
            try {
                _log.error("FencesDAO:insert(fence)", (Throwable)e);
                bl = false;
            }
            catch (Throwable throwable) {
    ...
    public boolean update(FenceInstance fence) {
        ...
        try {
            ...
            boolean bl;
            try {
                _log.error("FencesDAO:update(fence)", (Throwable)e);
                bl = false;
            }
            catch (Throwable throwable) {
                DbUtils.closeQuietly((Connection)con, statement);
    ...
    public boolean delete(FenceInstance fence) {
        ...
        try {
            ...
            boolean bl;
            try {
                _log.error("FencesDAO:delete(fence)", (Throwable)e);
                bl = false;
            }
            catch (Throwable throwable) {
                DbUtils.closeQuietly((Connection)con, statement);
