...
public class BeastSoulShotItemHandler
    ...
    public boolean useItem(Playable playable, ItemInstance item, boolean ctrl) {
        ...
        if (!servitors.isEmpty()) {
            for (Servitor servitor : servitors) {
                ...
                if (servitor.getChargedSoulshotPower() > 0.0) continue;
                ...
                if (skillEntry == null) {
                    skillEntry = SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 2033, 1);
                }
