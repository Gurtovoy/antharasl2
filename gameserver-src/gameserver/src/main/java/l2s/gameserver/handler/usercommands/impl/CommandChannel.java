...
implements IUserCommandHandler {
    private static final int[] COMMAND_IDS = new int[]{92, 93, 96, 97};
    ...
    public boolean useUserCommand(int id, Player activeChar) {
        ...
        switch (id) {
            ...
            case 93: {
                ...
                activeChar.sendPacket((IBroadcastPacket)SystemMsg.ONLY_THE_CREATOR_OF_A_COMMAND_CHANNEL_CAN_USE_THE_CHANNEL_DISMISS_COMMAND);
                break;
            }
            case 96: {
                if (!activeChar.isInParty() || !activeChar.getParty().isInCommandChannel()) {
                ...
                if (!activeChar.getParty().isLeader(activeChar)) {
                    activeChar.sendPacket((IBroadcastPacket)SystemMsg.ONLY_A_PARTY_LEADER_CAN_LEAVE_A_COMMAND_CHANNEL);
                    return true;
                }
                l2s.gameserver.model.CommandChannel channel = activeChar.getParty().getCommandChannel();
            ...
            case 97: {
                ...
                activeChar.sendPacket((IBroadcastPacket)new ExMultiPartyCommandChannelInfoPacket(activeChar.getParty().getCommandChannel()));
            }
        }
        return true;
    }
