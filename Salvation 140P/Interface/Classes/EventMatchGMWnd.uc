...
function OnClickShowCommandWndButton()
{
	...
	if( CommandFileName == "" )
	{
		DialogShow(DialogModalType_Modalless, DialogType_Notice, GetSystemMessage( 1415 ), string(Self) );
		return;
	}
...
state WaitingState
{
	...
	function OnClickCreateEventMatchButton()
	{
		...
		if( Team1Name == "" )
		{
			DialogShow(DialogModalType_Modalless, DialogType_Notice, GetSystemMessage( 1418 ), string(Self) );
			return;
		}
		...
		if( Team2Name == "" )
		{
			DialogShow(DialogModalType_Modalless, DialogType_Notice, GetSystemMessage( 1419 ), string(Self) );
			return;
		}

		if( Team1Name == Team2Name )
		{
			DialogShow(DialogModalType_Modalless, DialogType_Notice, GetSystemMessage( 1420 ), string(Self) );
			return;
		}
...
state CreatedState
{
	...
	function OnClickStartButton()
	{
		...
		if( OptionFile == "" )
		{
			DialogShow(DialogModalType_Modalless, DialogType_Notice, GetSystemMessage( 1421 ), string(Self) );
			return;
		}
...
function bool ApplySkillRule( String a_OptionFile )
{
	...
	{
		DialogShow(DialogModalType_Modalless, DialogType_Notice, GetSystemMessage( 1425 ), string(Self) );
		return false;
	}
	...
	for( i = 0; i < Count; ++i )
	{
		...
		{
			DialogShow(DialogModalType_Modalless, DialogType_Notice, MakeFullSystemMsg( GetSystemMessage( 1427 ), String( i ) ), string(Self) );
			return false;
		}
...
function bool ApplyBuffRule()
{
	...
	{
		DialogShow(DialogModalType_Modalless, DialogType_Notice, GetSystemMessage( 1422 ), string(Self) );
		return false;
	}
	...
	for( i = 0; i < Count; ++i )
	{
		...
		{
			DialogShow(DialogModalType_Modalless, DialogType_Notice, MakeFullSystemMsg( GetSystemMessage( 1423 ), String( i ) ), string(Self) );
			return false;
		}

		if( !GetINIInt( "Buff", "BuffLv" $ i, Level, OptionFile ) )
		{
			DialogShow(DialogModalType_Modalless, DialogType_Notice, MakeFullSystemMsg( GetSystemMessage( 1424 ), String( i ) ), string(Self) );
			return false;
		}
