...
public class BotCheckAnswerListner
implements OnAnswerListener {
    ...
    public void sayYes() {
        ...
        boolean rightAnswer = BotCheckManager.checkAnswer(this._qId, true);
        if (rightAnswer) {
            player.increaseBotRating();
            this.sendFeedBack(player, true, player.isLangRus());
        } else {
            this.sendFeedBack(player, false, player.isLangRus());
    ...
    public void sayNo() {
        ...
        boolean rightAnswer = BotCheckManager.checkAnswer(this._qId, false);
        if (rightAnswer) {
            player.increaseBotRating();
            this.sendFeedBack(player, true, player.isLangRus());
        } else {
