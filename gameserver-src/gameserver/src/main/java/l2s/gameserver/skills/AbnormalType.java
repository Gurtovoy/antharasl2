...
public enum AbnormalType {
    ...
    CLASS_IS_BUFF(518),
    GREATER_SERVITOR_BUFF(519),
    MASS_HEAL_BUFF(520),
    VITALITY_TIME_UP(530),
    HORSE_POWER(531),
    ACADEMY_BENEFACTION(532),
    WIND_BLEND(536),
    ALONERS_TACT(537),
    SHADOW_HUNTER(538),
    CRITICAL_CHANCES(539),
    SHADOW_FLASH(540),
    CRIPPLING_DANCE(542),
    DESERT_THIRST(546),
    FACEOFF(548),
    ...
    STEEL_MIND(596),
    SPALLATION(597),
    BLOCK_INVINCIBILITY(605),
    SONG_WEAPON(610),
    SONG_DEFENCE(612),
    DIVINITY_OF_EINHASAD(618),
    SHARING_EQUIPMENT(620),
    SHILLIEN_PROTECTION(621),
    BARRIER(622),
    ARMOR_BREAKER(623),
    EXOSKELETAL_SHIELD(626),
    BIG_BODY_COMBINATION(629),
    BIG_BODY_COMBINATION_TG(630),
    CURSE_EXPOSURE(633),
    FREEZING_INVOKE(634),
    CLAN_TEAMWORK(643),
    ABNORMAL_ITEM2(-1),
    ...
    RESEARCH_REWARD(-1),
    RESEARCH_SUCCESS(-1),
    LA_VIE_EN_ROSES_ENERGY(-1),
    SHIELD_OF_SACRIFICE(-1),
    AGATHION_SONG_DANCE(-1),
