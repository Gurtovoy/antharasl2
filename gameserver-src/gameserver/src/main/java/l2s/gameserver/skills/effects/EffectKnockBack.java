...
extends EffectFlyAbstract {
    ...
    public void onStart(Abnormal abnormal, Creature effector, Creature effected) {
        ...
        if (effected.getFlags().getKnockBacked().start(this)) {
            ...
            effected.broadcastPacket(new FlyToLocationPacket(effected, new Location(x, y, z), FlyToLocationPacket.FlyType.PUSH_HORIZONTAL, this.getFlySpeed(), this.getFlyDelay(), this.getFlyAnimationSpeed()));
    ...
    public void onExit(Abnormal abnormal, Creature effector, Creature effected) {
        if (effected.getFlags().getKnockBacked().stop(this) && !effected.isPlayer()) {
