...
extends MerchantInstance {
    ...
    private void informFail(Player player, int itemId) {
        Functions.npcSay((NpcInstance)this, NpcString.WHAT_A_PREDICAMENT_MY_ATTEMPTS_WERE_UNSUCCESSUFUL, new String[0]);
    }
}
