...
extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        if (activeChar == null || StringUtils.isEmpty((CharSequence)this._name)) {
            return;
        }
        ...
        IBroadcastPacket msg = activeChar.getFriendList().requestFriendInvite(World.getPlayer(this._name));
        if (msg != null) {
