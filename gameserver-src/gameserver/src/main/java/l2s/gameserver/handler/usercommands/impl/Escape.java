...
implements IUserCommandHandler {
    ...
    public boolean useUserCommand(int id, Player activeChar) {
        ...
        SkillEntry skillEntry = activeChar.getPlayerAccess().FastUnstuck ? SkillEntry.makeSkillEntry(SkillEntryType.NONE, 2100, 1) : SkillEntry.makeSkillEntry(SkillEntryType.NONE, 2099, 1);
