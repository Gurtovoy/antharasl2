...
function OnRegisterEvent()
{
	...
	RegisterEvent( EV_GMVitalityEffectInfo );	//branch121212
...
function OnLoad()
{
	...
	//txtHeadMagicCastingSpeed.SetAnchor( m_WindowName, "TopLeft", "TopLeft", 147, 230 );	
	//txtMagicCastingSpeed.SetAnchor( m_WindowName, "TopLeft", "TopLeft", 240, 228 );
	
	//txtHeadMovingSpeed.SetAnchor( m_WindowName, "TopLeft", "TopLeft", 147, 247 );
	//txtGmMoving.SetAnchor( m_WindowName, "TopLeft", "TopLeft", 147, 274 );
	//txtGmMoving.SetText( temp1 );
	//txtMovingSpeed.SetAnchor( m_WindowName, "TopLeft", "TopLeft", 147, 262 );
...
function OnEvent( int a_EventID, String a_Param )
{
	...
	case EV_GMObservingUserInfoUpdate:
		...
		break;	
	case EV_GMVitalityEffectInfo://branch121212
